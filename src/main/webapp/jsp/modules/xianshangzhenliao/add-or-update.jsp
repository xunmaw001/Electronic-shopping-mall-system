		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑线上诊疗</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑线上诊疗</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">线上诊疗信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>医生账号</label>
										<input id="yishengzhanghao" name="yishengzhanghao" class="form-control" placeholder="医生账号">
									</div>
									<div class="form-group col-md-6">
										<label>医生姓名</label>
									...
									<div class="form-group col-md-6">
										<label>病情咨询</label>
										<input id="bingqingzixun" name="bingqingzixun" class="form-control" placeholder="病情咨询">
									</div>
									<div class="form-group col-md-6">
										<label>咨询日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xianshangzhenliao/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("xianshangzhenliao/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function dataBind(){
			...
			$("#bingqingzixun").val(ruleForm.bingqingzixun);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.bingqingzixun != null && res.data.bingqingzixun != ''){

					$("#bingqingzixun").val(res.data.bingqingzixun);
					}
