...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">线上诊疗管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>线上诊疗管理</span></li>
								<li class="breadcrumb-item active"><span>线上诊疗列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">线上诊疗列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										医生账号
									</label>
									<input type="text" id="yishengzhanghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yishengzhanghao')">医生账号<i id="yishengzhanghaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('yishengxingming')">医生姓名<i id="yishengxingmingIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('bingqingzixun')">病情咨询<i id="bingqingzixunIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		var tableName = "xianshangzhenliao";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
		...
		function search(){
			searchForm = { key: ""};
			if($('#yishengzhanghaoSearch').val() != null && $('#yishengzhanghaoSearch').val() != ''){
				searchForm.yishengzhanghao ="%" +  $('#yishengzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("xianshangzhenliao/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item,number){
			...
			var yishengzhanghaoCell  = document.createElement('td');

						 yishengzhanghaoCell.innerHTML = item.yishengzhanghao;


			row.appendChild(yishengzhanghaoCell);
			...
			var bingqingzixunCell  = document.createElement('td');

						 bingqingzixunCell.innerHTML = item.bingqingzixun;


			row.appendChild(bingqingzixunCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("xianshangzhenliao/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("xianshangzhenliao/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xianshangzhenliao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("xianshangzhenliao"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"xianshangzhenliao");
