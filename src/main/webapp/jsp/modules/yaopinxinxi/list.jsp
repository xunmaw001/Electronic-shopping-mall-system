...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">药品信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>药品信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">药品信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										药品名称
									</label>
									<input type="text" id="yaopinmingchengSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>图片</th>
											<th onclick="sort('shifouweichufangyao')">是否为处方药<i id="shifouweichufangyaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('xinghao')">型号<i id="xinghaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jiliang')">剂量<i id="jiliangIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('gongxiao')">功效<i id="gongxiaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shengchanshijian')">生产时间<i id="shengchanshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shifouweichufangyaoCell  = document.createElement('td');

						  shifouweichufangyaoCell.innerHTML = item.shifouweichufangyao; 

			row.appendChild(shifouweichufangyaoCell);
			var xinghaoCell  = document.createElement('td');

						 xinghaoCell.innerHTML = item.xinghao;


			row.appendChild(xinghaoCell);
			var jiliangCell  = document.createElement('td');

						 jiliangCell.innerHTML = item.jiliang;


			row.appendChild(jiliangCell);
			var gongxiaoCell  = document.createElement('td');

						 gongxiaoCell.innerHTML = item.gongxiao;


			row.appendChild(gongxiaoCell);
			var shengchanshijianCell  = document.createElement('td');

						  shengchanshijianCell.innerHTML = item.shengchanshijian;


			row.appendChild(shengchanshijianCell);
			...
			var yaopinxiangqingCell  = document.createElement('td');
