...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑药品信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>药品信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑药品信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">药品信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>是否为处方药</label>
										<select id="shifouweichufangyaoSelect" name="shifouweichufangyao" class="form-control">
												<option value=""></option>
												<option class="shifouweichufangyaoOption" value="是">
													是
												</option>
												<option class="shifouweichufangyaoOption" value="否">
													否
												</option>
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>型号</label>
										<input id="xinghao" name="xinghao" class="form-control" placeholder="型号">
									</div>
									<div class="form-group col-md-6">
										<label>剂量</label>
										<input id="jiliang" name="jiliang" class="form-control" placeholder="剂量">
									</div>
									<div class="form-group col-md-6">
										<label>功效</label>
										<input id="gongxiao" name="gongxiao" class="form-control" placeholder="功效">
									</div>
									<div class="form-group col-md-6">
										<label>生产时间</label>
										<div id="shengchanshijianDate" class="input-append date form_datetime">
											<input id="shengchanshijian-input" name="shengchanshijian" size="15" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>生产厂家</label>
										<input id="shengchanchangjia" name="shengchanchangjia" class="form-control" placeholder="生产厂家">
									</div>
									<div class="form-group col-md-6">
										<label>价格</label>
										<input id="price" type="number" name="price" class="form-control" placeholder="价格">
											...
											<div class="form-group  col-md-12">
												<label>药品详情</label>
												<div><div class="upload"><input id="yaopinxiangqingupload" name="file" type="file">选择文件</div>
	...
	<script>
		...
		function dateTimePick(){
			...
			$("#shengchanshijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			var shifouweichufangyaoOptions = document.getElementsByClassName("shifouweichufangyaoOption");
			for(var shifouweichufangyaoCount = 0; shifouweichufangyaoCount < shifouweichufangyaoOptions.length;shifouweichufangyaoCount++){
				if(shifouweichufangyaoOptions[shifouweichufangyaoCount].getAttribute('value') == ruleForm.shifouweichufangyao){
					shifouweichufangyaoOptions[shifouweichufangyaoCount].setAttribute('selected','selected');
				}
			}
			$("#xinghao").val(ruleForm.xinghao);	
			$("#jiliang").val(ruleForm.jiliang);	
			$("#gongxiao").val(ruleForm.gongxiao);	
			$("#shengchanshijian-input").val(ruleForm.shengchanshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shifouweichufangyao != null && res.data.shifouweichufangyao != ''){

					var shifouweichufangyaoOptions = document.getElementsByClassName("shifouweichufangyaoOption");
						for(var shifouweichufangyaoCount = 0; shifouweichufangyaoCount < shifouweichufangyaoOptions.length;shifouweichufangyaoCount++){
							if(shifouweichufangyaoOptions[shifouweichufangyaoCount].getAttribute('value') == res.data.shifouweichufangyao){
								shifouweichufangyaoOptions[shifouweichufangyaoCount].setAttribute('selected','selected');
							}
						}
					}
					if(res.data != null && res.data != '' && res.data.xinghao != null && res.data.xinghao != ''){

					$("#xinghao").val(res.data.xinghao);
					}
					if(res.data != null && res.data != '' && res.data.jiliang != null && res.data.jiliang != ''){

					$("#jiliang").val(res.data.jiliang);
					}
					if(res.data != null && res.data != '' && res.data.gongxiao != null && res.data.gongxiao != ''){

					$("#gongxiao").val(res.data.gongxiao);
					}
					if(res.data != null && res.data != '' && res.data.shengchanshijian != null && res.data.shengchanshijian != ''){

					$("#shengchanshijian-input").val(res.data.shengchanshijian);
					$('#shengchanshijianFileName').val(res.data.shengchanshijian)
					}
