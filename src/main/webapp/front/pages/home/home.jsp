	...
	<body>
		...
		<div id="app">
			...
			<div class="data-container layui-row">
				...
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../yaopinxinxi/detail.jsp?id='+item.id)" class="data-item layui-col-md3"  v-for="(item,index) in yaopinxinxiList" v-bind:key="index" v-if="item">
						...
						<img class="cover" :src="item.tupian?item.tupian.split(',')[0]:''">
			...
			<div class="data-container layui-row">
				<h2 class="index-title"> DATA SHOW </h2>
				<div class="line-container">
					<p class="line"> 医生信息展示 </p>
				</div>
				<div style="text-align: center;margin-top: 20px;">
					<button @click="jump('../yishengxinxi/list.jsp')" type="button" class="layui-btn layui-btn-primary">查看更多>></button>
				</div>
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../yishengxinxi/detail.jsp?id='+item.id)" class="data-item layui-col-md3"  v-for="(item,index) in yishengxinxiList" v-bind:key="index" v-if="item">
																																										
						<img class="cover" :src="item.touxiang?item.touxiang.split(',')[0]:''">
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
				...
				http.request('config/list', 'get', {
					...
					vue.yaopinxinxiList = res.data.list
                                                                                                ...
                                                                                                http.request(`yishengxinxi/list?limit=4`, 'get', {
					page: 1,
					limit: 4
				}, function(res) {
