					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="yishengzhanghao" id="yishengzhanghao">
									<option value="">请选择</option>
									<option v-for="(item,index) in yishengzhanghao" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="shanzhanglingyu" id="shanzhanglingyu" placeholder="擅长领域" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">个人简介</label>
							<div class="layui-input-block">
								<input type="text" name="gerenjianjie" id="gerenjianjie" placeholder="个人简介" autocomplete="off" class="layui-input">
							</div>
						</div>
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                								...
                								http.request(`option/yisheng/yishengzhanghao`,'get',{},(res)=>{
					vue.yishengzhanghao = res.data
				});
				form.on('select(yishengzhanghao)', (data) => {
					console.log(data.value);
					http.request('follow/yisheng/yishengzhanghao', 'get', {
						columnValue: data.value
					}, function(res) {
																														jquery("#yishengxingming").val(res.data.yishengxingming)
																																				jquery("#nianling").val(res.data.nianling)
																																																					})
				});
																								// 上传图片
