				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="bingqingzixun" id="bingqingzixun" placeholder="病情咨询" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">咨询日期</label>
							<div class="layui-input-block">
								<input type="text" name="zixunriqi" id="zixunriqi" placeholder="咨询日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
